...
root.iconbitmap('ai_lt.ico') # https://tkinker.com/images/ai_lt.ico
#Set Color Scheme
	...
	if chat_entry.get():
		...
		try:
			if os.path.isfile(filename):
				...
				# Load the data from the files into a variable
				...
				my_text.insert(END, "\n\nYou Need An API key to Talk w ChatGPT.  Get one here\nhttps://beta.openai.com/account/api-keys")
...
def save_key():
	...
	# Hide API Frame api_frame.pack_forget()
...
my_text = Text(text_frame, bg="#343638",
	 width=65, bd=1, fg="#d6d6d6",relief="flat",wrap=WORD,
...
# Add the scrollbar to the texbbox
...
api_save_button = customtkinter.CTkButton(api_frame,
	text="Save Key", command=save_key)
